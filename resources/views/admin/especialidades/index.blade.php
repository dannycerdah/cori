...
@section('title', 'Especialidades — Clínica CORI')
@section('description', 'Gestión de especialidades médicas de Clínica CORI.')
...
<section class="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        ...
        <h1 class="mt-4 text-3xl font-extrabold text-brand-blue dark:text-white md:text-4xl">Especialidades</h1>
        <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">Crea y administra las especialidades médicas de la clínica.</p>
    </div>

    @livewire('admin.especialidades-manager')
</section>
@endsection
